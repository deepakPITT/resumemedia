 ...
 * @author ankita
 */
public class viewEditProject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("value is "+ projectID);
         HttpSession session = request.getSession();
         session.setAttribute("projectID", projectID);
          // HttpSession session = session.setAttribute("selectedprojectID", projectID);
